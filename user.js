...
<style>
#entryCategoryAPI {
background-image: url(/lib/entry-js/images/looks.svg);
...
background-image: url(/lib/entry-js/images/looks_on.svg);
background-color: #00b6b1;
border-color: #00b6b1;
color: #fff;
}
</style>
`) $('#entryCategoryAPI').append('user'),console.log("user블럭은유저분들이만드신블럭들이모두있는곳입니다~"),alert("user블럭로딩완료!")
